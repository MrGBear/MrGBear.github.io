...
export function calculateWHS() {
    ...
    // Berechnung des Durchschnittswertes der besten 8/10 (nochmal recherchieren) Ergebnisse
        /*

    ### mind 20 Spiele 
    FOREACH SPIEL IN Scoring Record:
    -> SpielHandicap vorhanden? 
    -> Nein? -> Berechne Spiel handicap
    -> Spiel Handicap unter den besten 8?
    -> Ja -> Speichern 
    ...
    */
    ...
    // Zurückgabe des Durchschnittswertes 
...
function test() { 
    ...
    //Setup
    const { it, assert } = require('./test/test_util');
